...
const MessageModelSchema = CollectionSchema(
  ...
  properties: {
    ...
    r'isLocalSender': PropertySchema(
      id: 1,
      name: r'isLocalSender',
      type: IsarType.bool,
    ),
...
void _messageModelSerialize(
  ...
  writer.writeBool(offsets[1], object.isLocalSender);
...
MessageModel _messageModelDeserialize(
  ...
  object.id = id;
  object.isLocalSender = reader.readBool(offsets[1]);
...
P _messageModelDeserializeProp<P>(
  ...
  switch (propertyId) {
    ...
    case 4:
      return (reader.readString(offset)) as P;
    case 5:
      return (_MessageModelstatusValueEnumMap[reader.readStringOrNull(
                offset,
              )] ??
              MessageStatus.sending)
          as P;
...
extension MessageModelQueryFilter
  ...
  QueryBuilder<MessageModel, MessageModel, QAfterFilterCondition>
  chatIdStartsWith(String value, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
  ...
  QueryBuilder<MessageModel, MessageModel, QAfterFilterCondition>
  chatIdEndsWith(String value, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
  ...
  QueryBuilder<MessageModel, MessageModel, QAfterFilterCondition>
  isLocalSenderEqualTo(bool value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        FilterCondition.equalTo(property: r'isLocalSender', value: value),
      );
    });
  }
...
extension MessageModelQuerySortBy
  ...
  QueryBuilder<MessageModel, MessageModel, QAfterSortBy> sortByIsLocalSender() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isLocalSender', Sort.asc);
    });
  }

  QueryBuilder<MessageModel, MessageModel, QAfterSortBy>
  sortByIsLocalSenderDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isLocalSender', Sort.desc);
    });
  }
...
extension MessageModelQuerySortThenBy
  ...
  QueryBuilder<MessageModel, MessageModel, QAfterSortBy> thenByIsLocalSender() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isLocalSender', Sort.asc);
    });
  }
...
extension MessageModelQueryWhereDistinct
  ...
  distinctByIsLocalSender() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'isLocalSender');
    });
  }
...
extension MessageModelQueryProperty
  ...
  QueryBuilder<MessageModel, bool, QQueryOperations> isLocalSenderProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'isLocalSender');
    });
  }
