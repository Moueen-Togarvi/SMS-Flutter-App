...
const UserModelSchema = CollectionSchema(
  ...
  properties: {
    ...
    r'isLocal': PropertySchema(id: 1, name: r'isLocal', type: IsarType.bool),
...
extension UserModelQueryWhereSort
  ...
  QueryBuilder<UserModel, UserModel, QAfterWhere> anyIsLocal() {
    return QueryBuilder.apply(this, (query) {
...
extension UserModelQueryWhere
  ...
  QueryBuilder<UserModel, UserModel, QAfterWhereClause> isLocalEqualTo(
    bool isLocal,
  ) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(
        IndexWhereClause.equalTo(indexName: r'isLocal', value: [isLocal]),
      );
    });
  }

  QueryBuilder<UserModel, UserModel, QAfterWhereClause> isLocalNotEqualTo(
    bool isLocal,
  ) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
...
extension UserModelQueryFilter
  ...
  QueryBuilder<UserModel, UserModel, QAfterFilterCondition> isLocalEqualTo(
    bool value,
  ) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
...
extension UserModelQuerySortBy on QueryBuilder<UserModel, UserModel, QSortBy> {
  ...
  QueryBuilder<UserModel, UserModel, QAfterSortBy> sortByIsLocal() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isLocal', Sort.asc);
    });
  }

  QueryBuilder<UserModel, UserModel, QAfterSortBy> sortByIsLocalDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension UserModelQuerySortThenBy
  ...
  QueryBuilder<UserModel, UserModel, QAfterSortBy> thenByIsLocal() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isLocal', Sort.asc);
    });
  }

  QueryBuilder<UserModel, UserModel, QAfterSortBy> thenByIsLocalDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isLocal', Sort.desc);
    });
  }
...
extension UserModelQueryWhereDistinct
  ...
  QueryBuilder<UserModel, UserModel, QDistinct> distinctByIsLocal() {
    return QueryBuilder.apply(this, (query) {
...
extension UserModelQueryProperty
  ...
  QueryBuilder<UserModel, bool, QQueryOperations> isLocalProperty() {
    return QueryBuilder.apply(this, (query) {
